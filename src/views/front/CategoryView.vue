        ...
        <ol class="breadcrumb bg-all px-0 mb-0 pb-3">
          ...
          <li class="breadcrumb-item dropdown Serif-TC">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              <li><router-link to="/category/紅茶" class="dropdown-item neutral-500">紅茶</router-link></li>
              <li><router-link to="/category/綠茶" class="dropdown-item neutral-500">綠茶</router-link></li>
              <li><router-link to="/category/青茶" class="dropdown-item neutral-500">青茶</router-link></li>
              <li><router-link to="/category/黑茶" class="dropdown-item neutral-500">黑茶</router-link></li>
            </ul>
          </li>
        </ol>
      </nav>
